    ...
    <div className="flex flex-col gap-20 pb-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative">
               ...
               <div className="relative aspect-video rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-surface group">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="p-8 md:p-10 rounded-2xl bg-surface/50 border border-white/5 hover:border-primary/30 transition-all duration-300 group flex flex-col items-center text-center">
              <div className="w-20 h-20 rounded-full bg-black border border-white/10 flex items-center justify-center mb-8 group-hover:border-primary/50 group-hover:shadow-[0_0_15px_rgba(242,78,30,0.3)] transition-all">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold uppercase text-white">It's Straightforward</h2>
        </div>

        <div className="relative">
          {/* Connector Line (Desktop) */}
          <div className="hidden md:block absolute top-[3.75rem] left-0 w-full h-px bg-white/10 -z-10" />

          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {/* Step 1 */}
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-10">
                <div className="w-28 h-28 bg-surface rounded-2xl flex items-center justify-center border border-white/10 shadow-2xl group-hover:border-primary/30 transition-colors">
                  <Icons.Clipboard className="w-10 h-10 text-primary opacity-80" strokeWidth={1.5} />
                </div>
                <div className="absolute -top-4 -right-4 w-10 h-10 rounded-full bg-red-600 border-4 border-[#09090b] flex items-center justify-center text-white font-bold text-sm shadow-lg">
                  1
                </div>
              </div>
              <h3 className="text-xl font-bold uppercase mb-4 tracking-wide">Plan Your Success</h3>
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-10">
                ...
                <div className="absolute -top-4 -right-4 w-10 h-10 rounded-full bg-orange-500 border-4 border-[#09090b] flex items-center justify-center text-white font-bold text-sm shadow-lg">
                  2
                </div>
              </div>
              <h3 className="text-xl font-bold uppercase mb-4 tracking-wide">Handle Everything Daily</h3>
              <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-10">
                ...
                <div className="absolute -top-4 -right-4 w-10 h-10 rounded-full bg-yellow-500 border-4 border-[#09090b] flex items-center justify-center text-black font-bold text-sm shadow-lg">
                  3
                </div>
              </div>
              <h3 className="text-xl font-bold uppercase mb-4 tracking-wide">Track What Works</h3>
              <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-surface/30 border border-white/5 rounded-2xl p-8 md:p-12">
               <h3 className="text-xl font-bold text-gray-500 uppercase tracking-wider mb-8 text-center pb-8 border-b border-white/5">
                  Other Agencies
               </h3>
               <ul className="space-y-6">
                  {[
                     ...
                     <li key={i} className="flex items-start gap-4">
                        <div className="min-w-[24px] w-6 h-6 rounded-full bg-white/5 flex items-center justify-center mt-0.5">
            ...
            <div className="bg-surface border border-white/10 rounded-2xl p-8 md:p-12 relative overflow-hidden">
               ...
               <h3 className="text-xl font-bold text-white uppercase tracking-wider mb-8 text-center pb-8 border-b border-white/10 relative z-10">
               ...
               <ul className="space-y-6 relative z-10">
                  {[
                     ...
                     <li key={i} className="flex items-start gap-4">
                        <div className="min-w-[24px] w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center mt-0.5">
            ...
            return (
              <div 
                ...
                className={`rounded-lg border transition-all duration-300 overflow-hidden cursor-pointer ${
                  isOpen 
                    ? 'bg-surface/50 border-primary shadow-[0_0_15px_rgba(242,78,30,0.1)]' 
                    : 'bg-surface/30 border-white/5 hover:border-white/10'
                }`}
              >
                <div className="p-6 flex justify-between items-center">
                  <h3 className={`font-bold text-lg select-none ${isOpen ? 'text-white' : 'text-gray-300'}`}>
                    {faq.question}
                  </h3>
      ...
      <section id="contact" className="max-w-4xl mx-auto px-4 w-full">
        <div className="relative rounded-3xl overflow-hidden bg-black border border-white/10 group">
           {/* Background Glows */}
